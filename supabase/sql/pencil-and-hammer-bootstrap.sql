...
alter table public.site_settings
  ...
  alter column about_mission_vision_eyebrow set default 'Mission & Vision',
  alter column about_mission_vision_title set default 'Design intent should survive the realities of execution.',
  alter column about_mission_vision_body set default 'Pencil And Hammer is built around a simple belief: strong interiors come from alignment, not handoff friction. We connect concept, technical coordination, procurement thinking, and delivery support so each decision strengthens the final space instead of compromising it.',
  alter column about_mission_title set default 'Our Mission',
  alter column about_mission_body set default 'To lead every project with one disciplined process that keeps strategy, detailing, and site execution working together from the first brief to the final handover.',
  alter column about_vision_title set default 'Our Vision',
  alter column about_vision_body set default 'To be the studio clients trust for interiors that feel calm, precise, and enduring because they are resolved with as much rigor in delivery as they are in design.',
...
set
  ...
  about_mission_vision_eyebrow = 'Mission & Vision',
  about_mission_vision_title = 'Design intent should survive the realities of execution.',
  about_mission_vision_body = 'Pencil And Hammer is built around a simple belief: strong interiors come from alignment, not handoff friction. We connect concept, technical coordination, procurement thinking, and delivery support so each decision strengthens the final space instead of compromising it.',
  about_mission_title = 'Our Mission',
  about_mission_body = 'To lead every project with one disciplined process that keeps strategy, detailing, and site execution working together from the first brief to the final handover.',
  about_vision_title = 'Our Vision',
  about_vision_body = 'To be the studio clients trust for interiors that feel calm, precise, and enduring because they are resolved with as much rigor in delivery as they are in design.',
